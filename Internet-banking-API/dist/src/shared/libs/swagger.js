...
const swaggerDefinition = {
    ...
    info: {
        ...
        version: '1.0',
        description: 'This is the API documentation for the Internet Banking API, you can find more about this project in the following links:',
        contact: {
            name: 'Angel Lopez',
    ...
    paths: {
        ...
        '/api/product/update/{id}': {
            put: {
                ...
                description: 'You need to login to update a Product and you can only update your own Product',
                security: [
                    {
                        Bearer: []
                    }
